...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    final_score = player_score + take_turn(num_rolls,player_score,opponent_score,dice)
    sum = sus_points(final_score)
    return sum


    # END PROBLEM 4

#note:take turn 只是一次的分,sus_update已经是最后的总分
